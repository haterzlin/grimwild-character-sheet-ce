...
CS_PANEL_REPLACEMENTS = {
    "artificer": [
        ("Artificer", "Vynálezce"),
        ("""<strong>Ingenuity:</strong> You harness the power of creativity. You know 6 touchstones from the arcana crucibles, and have created 2 major arcana using them. Anyone can use them with the most relevant stat (as arcana), though it always carries risk for those other than you. Given time, you can: rebuild them using any other touchstones you know - pull off a potent feat of mechanical ingenuity. You can push yourself to do it on the spot.""", """<strong>Vynalézavost:</strong> Spoutáváš moc tvořivosti. Znáš 6 ohnisek z katalyzátorů arkan a vytvořil jsi pomocí nich 2 silná arkana. Kdokoli je může použít s nejvhodnější vlastností jako arkana, pro každého kromě tebe však vždy nesou riziko. Když máš čas, můžeš je přestavět s jinými známými ohnisky nebo provést mocný čin mechanické vynalézavosti. Můžeš se překonat a zvládnout to okamžitě."""),
