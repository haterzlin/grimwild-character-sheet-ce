...
CS_PANEL_REPLACEMENTS = {
    "artificer": [
        ("Artificer", "Vynálezce"),
        ("""<strong>Ingenuity:</strong> You harness the power of creativity. You know 6 touchstones from the arcana crucibles, and have created 2 major arcana using them. Anyone can use them with the most relevant stat (as arcana), though it always carries risk for those other than you. Given time, you can: rebuild them using any other touchstones you know - pull off a potent feat of mechanical ingenuity. You can push yourself to do it on the spot.""", """<strong>Vynalézavost:</strong> Využíváš sílu kreativity. Znáš 6 ohnisek z katalyzátorů arkán a vytvořil jsi pomocí nich 2 silné arkány, které může používat kdokoli (nejvhodnější vlastností jako arkány), ovšem pouze ty bez rizika. Když máš čas, můžeš je přestavět s jinými tobě známými ohnisky - předvést tak mocný čin mechanické vynalézavosti. Můžeš se překonat a zvládnout to okamžitě."""),
        ("""<strong>Engineer:</strong> Take +1d at creating, repairing, or destroying mechanisms and arcana. You can also deconstruct arcana to learn their touchstones, destroying them in the process.""", """<strong>Inženýr:</strong> Máš +1 kostku při vytváření, opravách nebo ničení mechanismů a arkán. Arkány můžeš také rozebrat a naučit se jejich ohniska; tím je zničíš."""),
        ("[Growth: At levels 2, 4, and 6, gain +1 major arcana and +2 learned touchstones.]", "[Růst: Na úrovních 2, 4 a 6 získáš +1 silnou arkánu a +2 naučená ohniska.]"),
        ("""<strong>Animate Objects:</strong> Given time, you can bestow a semblance of life into objects, giving them a 2d Animated power pool. They can only act within their nature or with simple one-word commands. They can roll 1d of their power pool to assist you. You can reliably command up to three of these at a time, with others following their nature.""", """<strong>Oživování předmětů:</strong> Když máš čas, můžeš předmětům propůjčit náznak života a dát jim silový bank 2 kostek oživení. Jednají jen podle své povahy nebo podle jednoduchých jednoslovných příkazů. Mohou hodit 1 kostkou ze svého banku, aby ti pomohly. Spolehlivě ovládáš až tři najednou; ostatní jednají dle své podstaty."""),
        ("""<strong>Artificial Parts:</strong> You have enhanced replacement body parts. Choose 3 benefits for them: built-in weapon - detachable - independent - keen sense - storage - strong. Each perk can be activated once per session to take +1d on a related roll. They also have a drawback: noisy - horrifying - unreliable - power source.""", """<strong>Umělé části těla:</strong> Máš vylepšené náhradní části těla. Vyber si 3 výhody: vestavěná zbraň - odnímatelné - samostatné - bystrý smysl - úložný prostor - silné. Každou výhodu můžeš jednou za sezení aktivovat pro +1 kostku k souvisejícímu hodu. Mají také nevýhodu: hlučné - děsivé - nespolehlivé - vyžadují zdroj energie."""),
    ...
    "psion": [
        ...
        ("[Growth: At levels 3 and 6, gain +1 instability slot at 0d, and +1 bastion.]", "[Růst: Na úrovních 3 a 6 získáš +1 políčko nestability na +0 trnů a +1 baštu.]"),
        ("""<strong>Echo:</strong> Once per session, you can create a duplicate as a 3d power pool. It is a second version of you, acting as you with shared knowledge, ability, and resources. You can drop 1d of its pool to have it: assist you - trade places with you.""", """<strong>Odraz:</strong> Jednou za sezení můžeš vytvořit dvojníka jako bank 3 kostek moci. Je to druhá verze tebe, jedná jako ty a sdílí tvé znalosti, schopnosti i zdroje. Můžeš odebrat 1 kostku z jeho banku, aby ti pomohl nebo si s tebou vyměnil místo."""),
        ...
        ("""<strong>Shift Form:</strong> Each session, you have a 2d Shifter resource pool. You can roll the pool to alter your features and form, though you keep the same basic shape.""", """<strong>Změna podoby:</strong> Každé sezení máš bank 2 kostek proměny. Můžeš ho hodit a změnit své rysy a podobu, ale zachováš si stejný základní tvar."""),
        ("Psion", "Psionik"),
        ("Thread", "Zápletka"),
    ...
    "summoner": [
        ...
        ("""<strong>Shared Soul:</strong> You can merge with your vassal, sharing path talents, aspects, and incoming harm. You can choose to use the power pool or your own stats, and when your anchors break, take +1d on the story roll.""", """<strong>Sdílená duše:</strong> Můžeš splynout se svým vazalem a sdílet talenty cesty, aspekty i příchozí újmu. Můžeš použít silový bank nebo vlastní vlastnosti, a když se tvé kotvy zlomí, máš +1 kostku k hodu na příběh."""),
        ("Vassal", "Vazal"),
        ("Mark", "Oslabení"),
        ("Harm", "Újma"),
    ],
    "swashbuckler": [
        ...
        ("[Growth: At levels 2, 4, and 6, gain +1 panache per scene.]", "[Růst: Na úrovních 2, 4 a 6 získáš +1 švih za scénu.]"),
        ...
        ("""<strong>Lucky:</strong> Each session you have a 1d Luck pool. You can roll it as a bonus die after any roll you make and story rolls related to you. On a grim, take spark.""", """<strong>Štístko:</strong> Každé sezení máš bank s 1 kostkou štěstí. Můžeš ho hodit jako bonusovou kostku po libovolném svém hodu a po hodech na příběh, které se tě týkají. Při chmurném výsledku získáš jiskru."""),
    ...
    "witch": [
        ...
        ("""<strong>Herbalism:</strong> Before each session, use the herbalism crucible (pg. 83) to make two herb names. Each session, you have 1 trivial and 1 minor potion, chosen when they're used. The name is the touchstone. One time only, you can have 1 major potion.""", """<strong>Bylinkářství:</strong> Před každým sezením použij bylinkářský katalyzátor (str. 83) a vytvoř dvě jména bylin. Každé sezení máš 1 triviální a 1 slabší lektvar, vybrané při použití. Jméno je ohnisko. Jen jednou můžeš mít 1 silný lektvar."""),
